...
public class Testt extends Canvas implements Runnable {
	private static final long serialVersionUID = 1L;
	
	public Thread thread;
	public static int WIDTH = 120*7;
	public static int HEIGHT = 120*7;
	public static int maxPix = 1280*720;
	...
	public static void main(String[] args) {
		Testt crop = new Testt();
		crop.screen.add(crop);
		crop.start();
